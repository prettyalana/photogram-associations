...
class Photo < ApplicationRecord
  ...
  # belongs_to(:poster)
  # has_many(:comments, through: :commenter, source: :comment )
  # has_many(:likes, through: :fans, source: :like)
  # has_many(:fans, through: :users, source: :fan)
  ...
  # has_many(:fans, class_name: "User", foreign_key: "username")
