...
class User < ApplicationRecord
  ...
  # has_many(:accepted_sent_follow_requests, class_name: "FollowRequest", foreign_key: "commented_photos")
  # has_many(:accepted_received_follow_requests, class_name: "Comment", foreign_key: "commented_photos")
  # has_many(:followers, through: :, source: :)
  # has_many(:leaders, through: :, source: :)
  # has_many(:feed, through: :, source: :)
